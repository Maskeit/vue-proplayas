<template>
    <div v-if="isOpen"
        ...
        @click="closeModal">
        <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md overflow-hidden h-auto max-h-[90vh] overflow-y-auto"
            @click.stop>
...
const props = defineProps<{ isOpen: boolean; userData: HeaderProfile }>();
const emit = defineEmits(["close", "update"]);

const form = ref<HeaderProfile>({ ...props.userData });
